(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))a(o);new MutationObserver(o=>{for(const s of o)if(s.type==="childList")for(const i of s.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&a(i)}).observe(document,{childList:!0,subtree:!0});function n(o){const s={};return o.integrity&&(s.integrity=o.integrity),o.referrerPolicy&&(s.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?s.credentials="include":o.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function a(o){if(o.ep)return;o.ep=!0;const s=n(o);fetch(o.href,s)}})();const Fe="modulepreload",Me=function(e){return"/"+e},ce={},se=function(t,n,a){let o=Promise.resolve();if(n&&n.length>0){document.getElementsByTagName("link");const i=document.querySelector("meta[property=csp-nonce]"),p=(i==null?void 0:i.nonce)||(i==null?void 0:i.getAttribute("nonce"));o=Promise.allSettled(n.map(l=>{if(l=Me(l),l in ce)return;ce[l]=!0;const x=l.endsWith(".css"),Q=x?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${l}"]${Q}`))return;const L=document.createElement("link");if(L.rel=x?"stylesheet":Fe,x||(L.as="script"),L.crossOrigin="",L.href=l,p&&L.setAttribute("nonce",p),document.head.appendChild(L),x)return new Promise((Ce,Ae)=>{L.addEventListener("load",Ce),L.addEventListener("error",()=>Ae(new Error(`Unable to preload CSS for ${l}`)))})}))}function s(i){const p=new Event("vite:preloadError",{cancelable:!0});if(p.payload=i,window.dispatchEvent(p),!p.defaultPrevented)throw i}return o.then(i=>{for(const p of i||[])p.status==="rejected"&&s(p.reason);return t().catch(s)})};function m(e){return window.location.hostname==="localhost"||window.location.hostname==="127.0.0.1"?e:`https://ft-transcendence-rtjp.onrender.com${e}`}async function ye(){try{const e=m("/api/auth/verify"),t=await fetch(e,{credentials:"include"}),n=await t.json();return t.ok}catch(e){return console.error("JWT verification failed",e),!1}}async function Ne(e){const t=e.get("email");if(!t){alert("enter email to get the code");return}try{const n=m("/api/send2FACode"),a=await fetch(n,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:t}),credentials:"include"}),o=a.json();a.ok?alert("code has been sent."):alert("fail to send")}catch{alert("got info which is not json?")}}function Oe(e){const t=document.getElementById("qrModal"),n=document.getElementById("qrImage"),a=document.getElementById("closeModalBtn");t&&n&&(n.src=e,t.classList.remove("hidden"),a&&(a.onclick=()=>{t.classList.add("hidden")}))}async function De(e){const t=e.get("email");if(!t){alert("Enter email for auth app check");return}try{const n=m("/api/authAppSecretCheck"),a=await fetch(n,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:t}),credentials:"include"});if(!a.ok){alert("please register first.");return}const o=await a.json();o.qrCodeDataUrl?Oe(o.qrCodeDataUrl):alert("unexpected case?")}catch{alert("catched err")}}function Ue(){const e=document.getElementById("sendCodeBtn"),t=document.getElementById("loginForm");e&&e.addEventListener("click",async()=>{const n=new FormData(t),a=n.get("method");a==="email"?await Ne(n):a==="authApp"&&await De(n)})}async function je(){const e=document.getElementById("loginForm");e.addEventListener("submit",async t=>{t.preventDefault();const n=new FormData(e),a=n.get("email"),o=n.get("password"),s=n.get("code"),i=n.get("method");try{const p=m("/api/login"),l=await fetch(p,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:a,password:o,authCode:s,method:i}),credentials:"include"}),x=await l.json();l.ok?(alert("login succeeded"),se(()=>Promise.resolve().then(()=>Te),void 0).then(Q=>Q.navigate("/home"))):alert("login failed: "+String(x.error))}catch{alert("login failed?")}})}async function $e(){var e;(e=document.getElementById("showTermsBtn"))==null||e.addEventListener("click",t=>{var n;t.preventDefault(),(n=document.getElementById("terms"))==null||n.classList.toggle("hidden")})}async function He(){if(await ye()){se(()=>Promise.resolve().then(()=>Te),void 0).then(t=>t.navigate("/home"));return}Ue(),je(),$e()}function _e(){const e=document.getElementById("registerForm");e&&e.addEventListener("submit",async t=>{t.preventDefault();const n=new FormData(e),a=n.get("email"),o=n.get("password"),s=m("/api/register");try{const i=await fetch(s,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:a,password:o})}),p=await i.json();i.ok?(alert("registration succeeded"),g("/login")):alert("registration failed: "+p.error)}catch{console.error("registration failed?"),alert("registration failed?")}})}function Re(){var e;(e=document.getElementById("passwordForm"))==null||e.classList.remove("hidden")}function Z(){var e;(e=document.getElementById("passwordForm"))==null||e.classList.add("hidden")}async function qe(){const e=document.getElementById("oldPassword").value,t=document.getElementById("newPassword").value;try{const n=m("/api/profile/password"),a=await fetch(n,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({oldPassword:e,newPassword:t}),credentials:"include"}),o=await a.json();a.ok?alert("Password updated."):alert("Failed to update password: "+o.message),Z()}catch{alert("catched err: failed to update password."),Z()}}async function Je(){var e,t,n;(e=document.getElementById("showPasswordForm"))==null||e.addEventListener("click",Re),(t=document.getElementById("submitPasswordChange"))==null||t.addEventListener("click",qe),(n=document.getElementById("hidePasswordForm"))==null||n.addEventListener("click",Z)}function Y(e){const t=document.getElementById("profileName"),n=document.getElementById("changeName"),a=document.getElementById("nameInput"),o=document.getElementById("saveName");e?(t.classList.add("hidden"),n.classList.add("invisible"),a.classList.remove("hidden"),o.classList.remove("hidden"),a.value=t.textContent||"",a.focus()):(a.classList.add("hidden"),o.classList.add("hidden"),t.classList.remove("hidden"),n.classList.remove("invisible"))}async function We(e){try{const t=m("/api/profile/name");return(await fetch(t,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({newName:e}),credentials:"include"})).ok?(alert("name updated."),!0):(alert("name updating failed"),!1)}catch{return alert("name updating failed?"),!1}}function ze(){const e=document.getElementById("profileName"),t=document.getElementById("changeName"),n=document.getElementById("nameInput"),a=document.getElementById("saveName");t.addEventListener("click",()=>{Y(!0)}),a.addEventListener("click",async()=>{const o=n.value.trim();if(o===""||o===e.textContent){Y(!1);return}await We(o)&&(e.textContent=o),Y(!1)})}function be(e){const t=document.getElementById("avatarImg"),n=m(`/avatar/upload/${e}.png?${Date.now}`),a=m("/avatar/42.svg");console.log("avatarUrl: ",n,"defaultUrl: ",a),t.src=n,t.onerror=()=>{t.onerror=null,t.src=a}}async function Ve(e,t){const n=new FormData;n.append("avatar",t);try{const a=m("/api/avatar"),o=await fetch(a,{method:"POST",body:n,credentials:"include"}),s=await o.json();o.ok?(alert("avatar updated."),be(e)):alert(s.message||"avatar updating failed.")}catch{alert("Failed updating avatar?")}}async function Ge(e){document.getElementById("avatarImg");const t=document.getElementById("avatarInput");be(e.id),t.addEventListener("change",async()=>{var a;const n=(a=t.files)==null?void 0:a[0];if(n){if(n.size>5*1024*1024){alert("img limitation: 5MB");return}console.log("user id: ",e.id),await Ve(e.id,n)}})}function ve(e){const t=U(e);return t&&t.isFriend?t.online?"🟢":"🔴":"-"}function Qe(e){return U(e).isFriend?"bg-gray-400 cursor-not-allowed":"bg-blue-500 hover:bg-blue-600"}function ee(e){return U(e).isFriend?"added":"add"}function Ye(e){const t=document.getElementById(`onlineStatus${e}`);t&&U(e).isFriend&&(t.textContent=ve(e))}function Ke(e){const t=document.getElementById(`addFriend${e}`);if(t){t.textContent=ee(e);const n=U(e).isFriend;t.disabled=n,n?(t.classList.remove("bg-blue-500","hover:bg-blue-600"),t.classList.add("bg-gray-400","cursor-not-allowed")):(t.classList.add("bg-blue-500","hover:bg-blue-600"),t.classList.remove("bg-gray-400","cursor-not-allowed"))}}function K(e){U(e)&&(Ke(e),Ye(e))}function Xe(){document.querySelectorAll('[id^="addFriend"]').forEach(e=>{const t=Number(e.id.replace("addFriend",""));e.addEventListener("click",()=>{se(async()=>{const{addFriend:n}=await Promise.resolve().then(()=>et);return{addFriend:n}},void 0).then(({addFriend:n})=>n(t))})})}const B={},re=()=>{const e=window.location.protocol==="https:"?"wss:":"ws:",t=window.location.host;return`${e}//${t}/ws`};console.log(re());let c=new WebSocket(re());function we(){(!c||c.readyState===WebSocket.CLOSED)&&(c=new WebSocket(re())),c.onopen=()=>console.log("ws connected"),c.onclose=()=>console.log("ws closed"),c.onerror=e=>console.log("websocket error: ",e),c.onmessage=e=>{if(c.readyState!==WebSocket.OPEN){console.log("ws yet to be ready");return}const t=JSON.parse(e.data);console.log(t),t.method==="friendAdded"?(B[t.id]?B[t.id].isFriend=!0:B[t.id]={id:t.id,isFriend:!0,online:!1},K(t.id)):t.method==="onlineStatus"?(B[t.id]?B[t.id].online=t.online:B[t.id]={id:t.id,isFriend:!1,online:t.online},K(t.id)):t.method==="isFriend"&&(B[t.id]?B[t.id].isFriend=t.isFriend:B[t.id]={id:t.id,isFriend:t.isFriend,online:!1},K(t.id))}}function Ze(e){c&&c.readyState===WebSocket.OPEN&&c.send(JSON.stringify({method:"addFriend",targetId:e}))}function xe(e){c&&c.readyState===WebSocket.OPEN&&c.send(JSON.stringify({method:"checkFriendship",targetId:e}))}function Ee(e){c&&c.readyState===WebSocket.OPEN&&c.send(JSON.stringify({method:"checkOnline",id:e}))}function U(e){return B[e]||{id:e,isFriend:!1,online:!1}}function Ie(){c&&c.readyState===WebSocket.OPEN&&c.close()}const et=Object.freeze(Object.defineProperty({__proto__:null,addFriend:Ze,checkFriendship:xe,checkUserOnline:Ee,connectWebSocket:we,disconnectWebSocket:Ie,getFriendStatus:U},Symbol.toStringTag,{value:"Module"}));async function Be(){try{const e=m("/api/logout");(await fetch(e,{method:"POST",credentials:"include"})).ok?(Ie(),g("/login")):alert("logout failed")}catch{alert("logout failed")}}async function tt(){var e;(e=document.getElementById("deleteAccount"))==null||e.addEventListener("click",async()=>{try{const t=m("/api/account");(await fetch(t,{method:"DELETE",credentials:"include"})).ok?(alert("account deleted. logging out..."),Be()):alert("failed to delete account")}catch{alert("failed to delete account?")}})}function V(e){const t=document.createElement("div");return t.textContent=e,t.innerHTML}function nt(e){const t=document.getElementById("main-content");t.innerHTML=`
	...
	<div class="flex flex-col items-center">
		<div class="bg-white p-6 rounded shadow-md w-80 text-left">
			...
			<div class="flex flex-col space-y-2">
				...
				<a href="${e}" class="flex w-full items-center justify-center text-sm text-gray-600 underline">
	...
	`}const kt={"/":he,"/login":xt,"/register":Et,"/home":he,"/play":It,"/404":Bt,"/tournament":St},X={"/":me,"/login":He,"/register":_e,"/home":me,"/play":yt,"/tournament":wt};function le(e){var n;const t=kt[e];t||g("/404"),document.body.innerHTML=t(),(n=X[e])==null||n.call(X)}function de(e){const t={"/":"Home","/login":"Login","/register":"Register","/play":"Pong","/tournament":"Tournament"};document.title=t[e]||"ft_transcendence"}function g(e){history.pushState({},"",e),de(e),le(e)}function Lt(){document.body.addEventListener("click",e=>{const t=e.target;if(t.matches("[data-link]")){e.preventDefault();const n=t.getAttribute("href");n&&g(n)}})}window.addEventListener("load",()=>{le(location.pathname),de(location.pathname),Lt()});window.addEventListener("popstate",()=>{le(location.pathname),de(location.pathname)});const Te=Object.freeze(Object.defineProperty({__proto__:null,navigate:g},Symbol.toStringTag,{value:"Module"}));
