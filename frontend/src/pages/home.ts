	...
	return `
			...
			<nav id="sidebar" class="hidden w-64 bg-white fixed left-0 h-full p-10">
				<ul id="menu" class="space-y-2">
					...
					<li> <a href="#" class="block p-2 text-gray-800 hover:bg-gray-200 rounded text-center" data-tab="animatedProfile"> Animationed </a> </li>
			...
			<!-- Main Content -->
			<main id="main-content" class="flex flex-row flex-1 justify-center items-center min-h-screen w-full text-gray-800">
				...
				<div id="Render-case" class="text-xs absolute top-5 right-5">
					Waking up server... <br>
					login will appear soon
				</div>
